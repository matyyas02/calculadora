...
$primer_numero = $_POST['primer_numero'];
            $respuesta_correcta =($primer_numero * $segundo_numero);
        ...
        ?>
          <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">El resultado de la multiplicación es: <strong><? echo $respuesta_correcta; ?></strong></p>
                    <a href="multiplicacion.php" class="btn btn-primary">Volver</a>
    </body>
    <footer>
